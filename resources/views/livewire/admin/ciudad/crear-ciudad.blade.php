<div>
    <div class="flex flex-col gap-4">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Crear ciudad</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">Formulario para crear una nueva ciudad.</p>
    </div>
    ...
    <div
        ...
        <form wire:submit.prevent="crearCiudad" class="space-y-4 mt-4  p-2">

            <flux:field>
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">


                    <flux:input wire:model="nombre"   badge="Requerido" :label="__('Ciudad')" type="text" placeholder="Ciudad" autocomplete="nombre" />
