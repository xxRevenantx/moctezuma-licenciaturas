    ...
    <div class="w-full mx-auto space-y-6">
        ...
        <div>
            <form action="{{ route('admin.pdf.documentacion.documento_personal') }}" method="GET" target="_blank"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
                    ...
                    <!-- Fecha -->
                    <div>
                        <flux:input required label="Fecha de expedición" name="fecha_expedicion" id="fecha"
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex flex-wrap items-center gap-2 text-xs sm:text-sm">
                            <span
                                ...
                                <span
                                    class="text-[11px] uppercase tracking-wide text-neutral-500 dark:text-neutral-300">Matrícula</span>
                                <span class="font-mono text-xs">{{ $selectedAlumno['matricula'] ?? '' }}</span>
                            </span>
                            <span
                                class="inline-flex items-center gap-1 rounded-full bg-neutral-100 text-neutral-800 dark:bg-neutral-700 dark:text-neutral-100 px-2.5 py-0.5">
                                <span
                                    class="text-[11px] uppercase tracking-wide text-neutral-500 dark:text-neutral-300">CURP</span>
        ...
        <div class="space-y-3">
            ...
            <div x-data="{
                ...
                <button @click="toggle()"
                    class="w-full flex items-center justify-between rounded-2xl px-4 sm:px-5 py-3.5
