...
>
    ...
    <div
        ...
        role="dialog" aria-modal="true" aria-labelledby="titulo-modal-periodo"
        x-show="show"
    ...
    >
        ...
        <!-- Body -->
        <form wire:submit.prevent="actualizarPeriodo" class="relative px-5 sm:px-6 pb-5">
            <flux:field>
