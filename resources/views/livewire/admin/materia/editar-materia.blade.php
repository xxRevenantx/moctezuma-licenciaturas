...
>
    ...
    <div
        ...
        role="dialog" aria-modal="true" aria-labelledby="titulo-modal-materia"
        x-show="show"
    ...
    >
        ...
        <div class="px-5 sm:px-6 pt-4 pb-3 flex items-start justify-between gap-3">
            <div>
                <h2 id="titulo-modal-materia" class="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white">
                    Editar Materia <flux:badge color="indigo">{{ $nombre }}</flux:badge>
                </h2>
        ...
        <!-- Body -->
        <form wire:submit.prevent="actualizarMateria" class="px-5 sm:px-6 pb-5">
            <flux:field>
