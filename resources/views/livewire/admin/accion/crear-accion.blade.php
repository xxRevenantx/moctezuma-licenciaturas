<div>
    <div class="flex flex-col gap-4">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Crear Acción</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">Formulario para crear una nueva acción.</p>
    </div>
    ...
    <div
        ...
        <form wire:submit.prevent="crearAccion" class="space-y-4 mt-4  p-2">

            <flux:field>
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">


                    <flux:input wire:model.live="accion" :label="__('Acción')" type="text" placeholder="Nueva acción" autocomplete="accion" />

                    <flux:input wire:model="slug" :label="__('URL')" type="text" placeholder="URL de la acción" autocomplete="url" />

                    <flux:input wire:model="icono" :label="__('Ícono')" type="text" placeholder="Nombre del ícono" autocomplete="icono" />
