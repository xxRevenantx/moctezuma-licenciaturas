...
>
    ...
    <div
        ...
        role="dialog" aria-modal="true" aria-labelledby="titulo-modal-grupo"
        x-show="show"
    ...
    >
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-neutral-600 dark:text-neutral-400">
                    <span class="inline-flex items-center gap-2">
                        ...
                        <flux:badge color="indigo">{{ $grupo }}</flux:badge>
                    </span>
                </p>
            </div>
        ...
        <!-- Body -->
        <form wire:submit.prevent="actualizarGrupo" class="px-5 sm:px-6 pb-5">
            <flux:field>
