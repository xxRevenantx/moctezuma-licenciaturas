<div>
    <div class="flex flex-col gap-4">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Crear Grupos</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">Formulario para crear un nuevo grupo.</p>
    </div>
    ...
    <div
        ...
        <form wire:submit.prevent="crearGrupo" class="space-y-4 mt-4  p-2">
            <flux:field>
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                    ...
                    <flux:input disabled badge="Requerido" wire:model="grupo" :label="__('Grupo')" type="text" placeholder="Grupo" />
