            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-2 mt-5 justify-center dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-5">
                ...
                <div class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-5">
                    ...
                    <flux:field>
                        ...
                        <div class="relative">
                            <!-- Overlay de carga mientras cambia generacion_id -->
                            <div wire:loading wire:target="generacion_id"
                                 class="absolute inset-0 z-10 flex items-center justify-center rounded-md bg-white/70 dark:bg-neutral-800/70">
                                <svg class="animate-spin h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z"></path>
                                </svg>
                                <span class="ml-2 text-sm">Cargando cuatrimestres...</span>
                            </div>
                            ...
                            <flux:select
                                ...
                                wire:target="generacion_id"
                            >
                                <option value="0">--Seleccione un cuatrimestre--</option>
                                @foreach($cuatrimestres as $cuatrimestre)
                                    <option value="{{ $cuatrimestre->cuatrimestre_id }}">
