...
<head>
    ...
    <title>OFICIO DE REGISTROS DE ESCOLARIDAD Y BOLETAS(ACTAS DE RESULTADOS) | GEN: {{ $generacion->generacion }}  </title>
</head>
<style>
...
@endphp
        ...
        <div class="contenedor">
          ...
          <p class="asunto"><b>Asunto:</b> Solicitud de validación</p>
