...
<head>
    ...
    <title>CONSTANCIA DE TÉRMINO | {{ $alumno->nombre }} {{ $alumno->apellido_paterno }} {{ $alumno->apellido_materno }}
    </title>
</head>
<style>
    @page {
...
<body>
    ...
    <div class="contenedor">
        ...
        <p style="text-align: center; font-size: 20px; color: #000; font-family: 'calibri';  margin-top: 20px;">
            Por este conducto se hace constar que
            @if ($alumno->sexo == 'M')
                la alumna
            @else
                el alumno
        ...
        <p class="descripcion2">
            ...
            días del mes de {{ \Carbon\Carbon::parse($fecha)->translatedFormat('F') }} del
            {{ \Carbon\Carbon::parse($fecha)->translatedFormat('Y') }}
            en Cd.
            Altamirano,Gro.
        ...
        <table>
            <tr>
                <td style="text-align: center;">
                    ...
                    <span class="rector" style="font-family: 'calibri'; font-size: 17px; bold;">{{ $rector->titulo }}
                        {{ $nombreRector }}</span><br>
                    <span style="font-family: 'calibri'; font-size: 17px;">{{ $rector->cargo }}</span>
                </td>
                <td style="text-align: center;">
                    <span style="display: block; border-top: 1px solid #000; width: 300px; margin: 0 auto;"></span>
                    <span class="directora"
                        style="font-family: 'calibri'; font-size: 17px; bold;">M.S.P.{{ $nombreDirectora }}</span><br>
