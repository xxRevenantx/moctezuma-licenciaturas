...
<head>
    ...
    <title>OFICIO DE FOLIOS | GEN: {{ $generacion->generacion }} </title>
</head>
<style>
    @page {
...
<body>
    ...
    <div class="contenedor">
        ...
        <p class="asunto"><b>Asunto:</b> Solicitud de Folios para certificados</p>
        ...
        <table class="subjefe">
            ...
            <tr>
                <td></td>
                <td>
                    <p><b>CATT'N</b><br><b style="text-transform: uppercase">{{ $nombreSubjefe }}</b>
                        <br>{{ $subjefe->cargo }}
                    </p>
                </td>
            </tr>
        ...
        <p class="descripcion">
            ...
            de manera atenta y respetuosa me dirijo a usted para solicitar los <b>FOLIOS PARA CERTIFICADOS</b> de la
            <b>GENERACIÓN {{ $generacion->generacion }}</b>. A continuación se anexan las licenciaturas
        ...
        <table style="width: 100%; margin-top:70px; font-weight:bold;">
            <tr>
                <td style="text-align: center; line-height: 15px;">
                    ...
                    <span class="rector" style="font-family: 'calibri'; font-size: 16px; bold;">
                        RECTOR <br>
                        {{ $rector->titulo }}
                ...
                <td style="text-align: center; line-height: 15px;">
                    <span style="display: block; border-top: 1px solid #000; width: 300px; margin: 0 auto;"></span>
                    <span class="rector" style="font-family: 'calibri'; font-size: 16px; bold;">
                        DIRECTORA DE CONTROL ESCOLAR <br>
                        {{ $directora->titulo }}
                        {{ $nombreDirectora }}</span><br>
                </td>
