...
<body>
    ...
    <table class="datos">
        ...
        <tr>
            <td style="text-align:center;" colspan="12">
                <h4 style="font-size:19.5px; margin-bottom:10px">CERTIFICADO DE ESTUDIOS</h4>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <p style="margin: 50px 0 0 0; font-size:15px; margin:0">CERTIFICA QUE: <b
                        style="font-size:15px;"><u>{{ $alumno->nombre }} {{ $alumno->apellido_paterno }}
                            {{ $alumno->apellido_materno }}</u></b> </p><br>
                <p style="font-size:13.5px; margin-top:-20px">CON CLAVE ÚNICA DE REGISTRO DE POBLACIÓN (CURP):
                    <b><u>{{ $alumno->CURP }}</u></b> <br>
    ...
    <p style="text-align:right; font-size:13.5px; margin-top:-3px">MATRÍCULA: <b><u>{{ $alumno->matricula }}</u></b>
    </p>
    ...
    <tr>
        ...
        <td width="50%" height="50%" valign="top">
            <table width="100%" class="tbl1" cellspacing="0">
                <thead>
                    <tr>
                        <th style="border-top:1px;  font-size:12px; border-left:1px transparent;background:#C5C5C5">
                            <b>ASIGNATURAS</b>
                        </th>
                        <th style="border-top:1px;  font-size:12px; border-left:1px solid #000;background:#C5C5C5;">
                            <b>CAL.<br>FINAL</b>
                        </th>

                        @if ($alumno->licenciatura_id == 6)
                            <th
                                style="border-top:1px transparent; font-size:12px; border-left:1px transparent;background:#C5C5C5;  font-size:10px; border-left:1px solid #000">
                                <b>OBSERVA<br>CIONES</b>
                            </th>
                        @else
                            <th
                                style="border-top:1px transparent; font-size:12px; border-left:1px transparent;background:#C5C5C5;   border-left:1px solid #000">
                                <b>OBSERVACIONES</b>
                            </th>
                        @endif
                ...
                <tbody>
                    @foreach ($cuatrimestres as $key => $cuatrimestre)
                        ...
                        @if ($cuatrimestre->id < 5)
                            ...
                            <tr class="cuatrimestres">
                                <td
                                    style="padding-top:10px; padding-left:10px; text-align:center; border-right:1px solid #000">
                            ...
                            @foreach ($materias as $key => $materia)
                                ...
                                <tr>
                                    <td
                                        style="text-align:left; font-size:11px; line-height:12px; text-transform:uppercase;
                                                 padding-left:10px; padding-top:0; padding-bottom:0; margin:0;  ">
                                        {{ $materia->nombre }}</td>
                                    <td
                                        style="text-align:center; font-size:11px; line-height:10px; text-transform:uppercase;
                    ...
                    @for ($i = 0; $i < $filas; $i++)
                        <tr>
                            <td>&nbsp;</td>
                            <td
                                style="padding-left:10px; text-align:center; border-right:1px solid #000; border-left:1px solid #000">
                                &nbsp;</td>
                            <td>&nbsp;</td>
                        </tr>
                    @endfor
            ...
            <table width="100%" class="tbl2" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        @if ($alumno->licenciatura_id == 6)
                            <th
                                style="border-top:1px transparent; font-size:12px; border-left:1px transparent;background:#C5C5C5; border-right:1px transparent; font-size:10px; border-left:1px solid #000">
                                <b>OBSERVA<br>CIONES</b>
                            </th>
                        @else
                            <th
                ...
                <tbody>
                    @foreach ($cuatrimestres as $key => $cuatrimestre)
                        ...
                        @if ($cuatrimestre->id > 4)
                            ...
                            <tr class="cuatrimestres">
                                <td
                                    style="padding-top:10px; padding-left:10px; text-align:center; border-left:1px solid #000;  border-right:1px solid #000">
                                    <strong>{{ $nombreCuatrimestre }}</strong><br>
                                    <strong>CICLO ESCOLAR: {{ $periodo ? $periodo->ciclo_escolar : '' }}</strong>
                                </td>
                                <td
                                ...
                                <td
                                    style="padding-top:10px; padding-left:10px; text-align:center; border-left:1px solid #000;">
                                </td>
                            </tr>
                            ...
                            @foreach ($materias as $key => $materia)
                                ...
                                <tr>
                                    <td
                                        style="text-align:left; font-size:11px; border-left:1px solid #000;line-height:7px; text-transform:uppercase;
                                                 padding-left:10px; padding-top:0; padding-bottom:0; margin:0;  ">
                                        {{ $materia->nombre }}</td>
                                    <td
                                        style="text-align:center; font-size:11px; line-height:12px; text-transform:uppercase;
                                                 padding-top:0; padding-bottom:0; margin:0; border-left:1px solid #000; ">
                                        @if (isset($calificacion) &&
                                                $calificacion->calificacion !== null &&
                                                $calificacion->calificacion !== '' &&
    ...
    <p style="text-align:justify; font-size:13px; margin:0; text-transform:uppercase; line-height:12px;">EL PRESENTE
        CERTIFICADO AMPARA <u><b>{{ count($materiasCalificables) }}</b></u> ASIGNATURAS, LAS CUALES CUBREN ÍNTEGRAMENTE
        EL PLAN DE ESTUDIOS DE LA <b> LICENCIATURA EN {{ $licenciatura->nombre }}</b>
        CON UN TOTAL DE <b>{{ $creditosMateriasCalificables }}</b> CRÉDITOS Y UN PROMEDIO GENERAL DE APROVECHAMIENTO DE
        <b>{{ $promedio }}</b> LA ESCALA DE CALIFICACIONES ES DE (5 A 10) Y LA MÍNIMA APROBATORIA ES DE 6 (SEIS).
    </p>
    ...
    <p style="text-align:justify; font-size:13px; text-transform:uppercase">
        EXPEDIDO EN CD. ALTAMIRANO, GUERRERO A <u>{{ $dia }}</u> DE <u>{{ $mes }}</u> del año
        <u>{{ $anio }}</u>.
    </p>

    @if ($alumno->licenciatura_id == 6)
        <table
            style="margin:25px auto 0; text-align:center; font-size:14px; width:100%; text-transform:uppercase; line-height:12px">
            <tr>
                <td colspan="5">_______________________________</td>
            </tr>
            <tr>
                <td colspan="5"><b>{{ $rector->nombre }} {{ $rector->apellido_paterno }}
                        {{ $rector->apellido_materno }}</b></td>
            </tr>
            <tr>
    ...
    @else
        <table
            style="margin:60px auto 0; text-align:center; font-size:13px; width:100%; text-transform:uppercase; line-height:12px">
            <tr>
                <td colspan="5">_______________________________</td>
            </tr>
            <tr>
    ...
    <table class="autoridades" style="width:100%; margin-top:24px">
        ...
        <tr>
            <td
                style="border:1px solid #000; width:250px; height:50px; text-align:center; font-size:16px;  border-bottom:1px transparent">
            </td>
            <td style="width:220px;  border-bottom:1px transparent"></td>
            <td
                style="border:1px solid #000; width:250px; height:50px; text-align:center; font-size:16px;border-bottom:1px transparent; border-top:1px transparent">
            </td>
        </tr>
        <tr>
            <td
                style="border:1px solid #000; width:200px; height:20px; font-size:16.5px; text-align:center; border-top:1px transparent; border-bottom:1px transparent; padding:0 10px; text-transform:uppercase">
                <p style="text-align:center;">{{ $nombreRevisado }}</p>
            </td>
            ...
            <td
                style="border:1px solid #000; width:200px; text-align:center; height:20px; border-top:1px transparent; border-bottom:1px transparent; font-size:16.5px; text-transform:uppercase">
                {{ $nombreJefe }}</td>
        </tr>
        <tr>
            <td
                style="width:200px; height:45px; font-size:16px; text-align:left; border:1px solid #000; border-top:1px transparent; padding:0 10px">
                FECHA:</td>
            <td style="width:220px;font-size:15px; text-align:center"></td>
            <td
                style="border:1px solid #000; width:200px;  text-align:center; height:55px;  text-align:center; font-size:16px; border-top:1px transparent">
            </td>
        </tr>
    </table>
    ...
    <table style="width:35%; margin-top:50px; margin-bottom:910px">
        <tr>
            <td
                style="width:100px; font-size:16px;padding:5px; text-align:center; line-height:15px; text-transform:uppercase">
    ...
    <table style="width:100%;">
        <tr>
            <td
                style="width:132px; line-height:10px; padding: 10px; text-align:center; font-size:16.5px; border:1.5px solid #000; ">
                FOLIO: <b>{{ $alumno->folio }}</b></td>
            <td style="border:1px solid #000; text-align:left; padding:0 5px; font-size:9.5px; border:1px transparent">
                ESTE CERTIFICADO REQUIERE DE TRAMITES ADICIONALES DE LEGALIZACIÓN. NO ES VÁLIDO SI PRESENTA BORRADURAS O
                ENMENDADURAS</td>
        </tr>
    </table>
