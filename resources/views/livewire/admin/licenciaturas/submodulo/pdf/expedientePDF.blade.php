...
<body>
    ...
    <div style="width: 12%; text-align: center; margin-top: 0px;  position: absolute; left: 50px; top: 20px; ">
        <img style="width: 100%;" src="{{ public_path('storage/licenciaturas/' . $alumno->licenciatura->imagen) }}"
    ...
    <div class="contenedor">
        ...
        <table>
            <tr>
                ...
                <td rowspan="3" class="foto">
                    <img src="{{ public_path('storage/estudiantes/' . $alumno->foto) }}" width="75" height="90"
            ...
            <tr>
                ...
                <td class="center" colspan="1">{{ \Carbon\Carbon::parse($alumno->fecha_nacimiento)->format('d/m/Y') }}
                </td>
        ...
        <div style="font-size: 15px; line-height: 14px; text-align: justify">
            <p>Todo pago que se efectúa al {{ $escuela->nombre }} presupone una serie de trámites internos, así como el
                apartado de
                un lugar en el curso por iniciar. Esto implica que el alumno que cubra cuotas por cualquier concepto y
                desee darse de baja
                estará sujeto a las siguientes condiciones:</p>

            <p style="text-indent: 10px"> <b>a)</b> Los alumnos que hayan realizado el pago total o parcial de la
                inscripción y cancelen su ingreso al Centro Universitario
                Moctezuma, no se les reembolsará monto alguno de lo pagado. Realizado el pago parcial de la inscripción
                deberán liquidar el
                100% de la inscripción al valor vigente de la misma en que esto suceda.
            </p>
            <p style="text-indent: 10px"><b>b)</b> En caso de reinscripción de alumnos en cuatrimestres o semestres
                avanzados, que cancelen su reingreso al Centro
                Universitario Moctezuma, no se les reembolsará monto alguno de lo pagado</p>
            <p style="text-indent: 10px"><b>c)</b> Cuando el alumno deje de asistir a clases sin previo aviso, el
            ...
            <p>El pago del cuatrimestre por anticipado tendrá un 8% de descuento exclusivamente sobre las colegiaturas
                sin incluir
                otras promociones. Como fecha límite para gozar de dicho descuento se tendrá la fecha establecida en el
                calendario de
                vencimientos.</p>

            <p><b>PAGOS VENCIDOS</b></p>

            <p style="text-indent: 10px"> <b>a)</b> Al acumularse <b>dos pagos</b> vencidos el alumno será suspendido,
                perdiendo el derecho al servicio educativo y administrativo aún
                y cuando se encontrara en periodo de exámenes parciales hasta que no liquide su adeudo. Las faltas no
                son justificables.
            </p>
            <p style="text-indent: 10px"> <b>b)</b> Al acumular <b>tres pagos vencidos</b> el alumno podrá ser dado de
                baja, no pudiendo asistir a clases hasta en tanto liquide el
                adeudo pendiente. Deberá tomarse en cuenta que las faltas acumuladas por este retraso afectara la
                acreditación de sus
                asignaturas.
            </p>

            <p style="text-indent: 10px"> <b>c)</b> Al finalizar el ciclo escolar, no podrán presentar exámenes de fin
                de período y extraordinarios si no se tienen liquidados al
                100% los pagos de Colegiaturas, Inscripción, Reinscripción, Cursos de Regularización y /o cualquier otro
                servicio.</p>
            <p style="text-indent: 10px"> <b>d)</b> Los pagos de colegiatura deberán realizarse dentro de los primeros
                cinco días de inicio del mes correspondiente.</p>
            ...
            <p style="text-transform: uppercase; font-weight: bold; ">
                ...
                _________________________________, EL DÍA _____________________ , LA CANTIDAD DE
                $_________________________
                _____________________________________MXN. POR CONCEPTO DE ADEUDOS EN COLEGIATURAS VENCIDAS. ESTE PAGARÉ
                CAUSARÁ
        ...
        <table style="width: 100%; text-align: center; border: none;">
            <tr>
                <td class="sin-borde" style="text-align: center; width: 50%;">
                    _____________________________________<br>NOMBRE Y FIRMA DEL ALUMNO</td>
                <td class="sin-borde" style="text-align: center; width: 50%;">
                    _____________________________________<br>NOMBRE Y FIRMA DEL PADRE/MADRE O TUTOR</td>
            </tr>
        </table>
