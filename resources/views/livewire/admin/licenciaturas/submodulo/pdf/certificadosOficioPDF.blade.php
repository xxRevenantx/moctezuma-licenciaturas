...
@endphp
        ...
        <div class="contenedor">
          ...
          <p class="descripcion">
            ...
            de manera atenta y respetuosa me dirijo a usted para solicitar la <b>validación y certificación de los certificados</b> de este centro de estudios
            de la <b>GENERACIÓN {{ $generacion->generacion }}</b>. A continuación se anexan las licenciaturas correspondientes a la
