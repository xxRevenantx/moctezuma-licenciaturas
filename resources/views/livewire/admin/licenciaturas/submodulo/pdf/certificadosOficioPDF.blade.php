...
<head>
    ...
    <title>OFICIO DE CERTIFICADOS | GEN: {{ $generacion->generacion }} </title>
</head>
<style>
    @page {
...
<body>
    ...
    <div class="contenedor">
        ...
        <p class="asunto"><b>Asunto:</b> Validación y Certificación</p>
        ...
        <table class="jefe">
            <tr>
                <td style="width:400px">
                    <p style="text-transform: uppercase; margin:0 ; padding:0"><b>{{ $nombreJefe }}</b></p>
                    <p style="line-height: 16px; margin-top:-1px ">{{ $jefe->cargo }}<br>
                        <b>P R E S E N T E</b>
                    </p>
                </td>
            </tr>
        ...
        <p class="descripcion">
            ...
            de manera atenta y respetuosa me dirijo a usted para solicitar la <b>validación y certificación de los
                certificados</b> de este centro de estudios
            de la <b>GENERACIÓN {{ $generacion->generacion }}</b>. A continuación se anexan las licenciaturas
        ...
        <p style="font-size: 19px; text-indent: 30px; line-height:20px;  margin-top:-10px">Quedando atento a nuestra
            solicitud, solo me resta enviar un afectuoso saludo y ponernos a sus finas atenciones.</p>
        ...
        <table style="width: 100%; margin-top:60px">
            <tr>
                <td style="text-align: center;">
                    ...
                    <span class="rector" style="font-family: 'calibri'; font-size: 16px; bold;">{{ $rector->titulo }}
                        {{ $nombreRector }}</span><br>
                </td>
