...
<div class="mt-8 space-y-8">
    ...
    <div class="rounded-2xl border border-gray-200/80 dark:border-gray-800 bg-white/90 dark:bg-gray-900/90 shadow-sm p-4 sm:p-5">
        <h4 class="flex items-center gap-2 text-sm font-semibold text-gray-800 dark:text-gray-100 mb-3">
            <span class="inline-flex h-6 w-6 items-center justify-center rounded-full bg-blue-50 text-blue-600 dark:bg-blue-900/40 dark:text-blue-200">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 5.25h16.5M6.75 9.75h10.5M10 14.25h4M11.25 18.75h1.5" />
                </svg>
            </span>
    ...
    <div class="rounded-2xl border border-gray-200/80 dark:border-gray-800 bg-white/80 dark:bg-gray-900/90 shadow-sm p-4 sm:p-5">
        <div class="overflow-x-auto">
            ...
            {{-- Aviso de filtros + botón PDF --}}
            @if($filtrar_generacion && $filtrar_cuatrimestre)
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-4 mb-4 text-sm rounded-2xl bg-gradient-to-r from-sky-50 via-blue-50 to-indigo-50 dark:from-sky-900/40 dark:via-indigo-900/40 dark:to-indigo-900/40 border border-blue-200/60 dark:border-blue-800/70">
                        ...
                        <div class="mt-0.5">
                            <span class="inline-flex h-7 w-7 items-center justify-center rounded-full bg-blue-600 text-white dark:bg-blue-500 shadow-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none">
                                    <path d="M5 12l4 4L19 6" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </span>
                        </div>
                        <div>
                    ...
                    <div class="shrink-0">
                        <form method="GET" action="{{ route('admin.pdf.horario-escolarizada') }}" target="_blank" class="inline-flex">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                            @foreach ($horas as $hora)
                                <tr class="hover:bg-gray-50/80 dark:hover:bg-gray-800/70 transition-colors">
                                    <td class="px-4 py-2 whitespace-nowrap text-xs sm:text-sm font-medium text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/80">
                                        {{ $hora }}
                                    </td>
                                    @foreach ($dias as $dia)
                                        <td class="px-4 py-2 align-top text-xs sm:text-sm text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-800">
                                            <select
    ...
    <div class="mt-4 rounded-2xl border border-gray-200/80 dark:border-gray-800 bg-white/90 dark:bg-gray-900/95 shadow-sm p-4 sm:p-5">
        ...
        {{-- Loader resumen profesores/horas --}}
        <div
            wire:loading.delay
            wire:target="actualizarHorario, filtrar_generacion, filtrar_cuatrimestre"
            class="w-full flex flex-col items-center justify-center gap-3 p-6 border border-dashed border-gray-300 dark:border-gray-700 rounded-2xl bg-gray-50/70 dark:bg-gray-900/70 text-center"
        >
        ...
        >
            <table class="min-w-full border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm bg-white dark:bg-gray-900 table-striped overflow-hidden">
                <thead class="bg-gray-100 dark:bg-gray-800/90">
                    <tr>
