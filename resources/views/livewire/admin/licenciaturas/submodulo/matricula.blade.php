<div>
    ...
    <div class="overflow-x-auto">
        ...
        <flux:input type="text" wire:model.live="search" placeholder="Buscar Estudiante..." class="p-2 mb-4 w-full" />
        ...
        <table class="min-w-full border-collapse border border-gray-200 table-striped">
            ...
            <tbody>
                @forelse($matricula as $key =>  $estudiante)
                    <tr :class="{'bg-blue-100': @js(in_array($estudiante->id, $selected))}">
                ...
                @empty
                    <tr>
                        <td colspan="11" class="border px-4 py-2 text-center">No hay estudiantes inscritos.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
            ...
            <div class="mt-4">
                @if(count($selected) > 0)
                    <flux:button
                        ...
                        Cambiar seleccionados ({{ count($selected) }})
                    </flux:button>
                @endif
            </div>
