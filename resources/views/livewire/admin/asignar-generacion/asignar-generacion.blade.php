<div>
    ...
    <div class="flex flex-col gap-4">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">Formulario para asignar una generación a una licenciatura y modalidad.</p>
    </div>
    ...
    <div x-data="{ open: false }" class="my-4">
        ...
        <button
            ...
            @click="open = !open"
            :aria-expanded="open"
            aria-controls="panel-asignar-generacion"
                ...
                <div class="rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-lg overflow-hidden">
                    ...
                    <div class="p-5 sm:p-6 lg:p-8">
                        ...
                        <div class="mb-5 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Asignar generación</h2>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Selecciona la licenciatura, la generación y la modalidad.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        <div class="flex items-center gap-3 rounded-xl bg-white/90 dark:bg-neutral-900/90 px-4 py-3 ring-1 ring-gray-200 dark:ring-neutral-700 shadow">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-200">Guardando asignación…</span>
                        </div>
                    </div>
                </div>
            </form>
