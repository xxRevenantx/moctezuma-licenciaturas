<div>
    ...
    <div class="flex flex-col gap-4">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">Formulario para asignar una generación a una licenciatura y
            modalidad.</p>
    </div>
                    ...
                    <div class="p-5 sm:p-6 lg:p-8">
                        ...
                        <div class="mb-5 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Selecciona la licenciatura, la
                                        generación y la modalidad.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <flux:field>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <flux:select badge="Requerido" label="Selecciona una modalidad"
                                    wire:model="modalidad_id">
                                    <flux:select.option value="0">--Selecciona una modalidad--</flux:select.option>
                                    @foreach($modalidades as $modalidad)
                                        <flux:select.option value="{{ $modalidad->id }}">{{ $modalidad->nombre }}
                                        </flux:select.option>
                                    @endforeach
                                </flux:select>
                            </div>
