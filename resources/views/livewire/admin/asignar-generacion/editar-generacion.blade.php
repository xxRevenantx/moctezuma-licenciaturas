       ...
       <form wire:submit.prevent="actualizarAsignacion">
        ...
        <div class="flex flex-col items-center justify-center gap-5 mb-4 ">
            ...
            <div class="mb-4">
                ...
                <flux:select  badge="Requerido" :label="__('Licenciatura')" wire:model="licenciatura_id" id="licenciatura_id" class="w-full">
                ...
                <flux:select  badge="Requerido" :label="__('Generación')" wire:model="generacion_id" id="generacion_id" class="w-full">
                    <flux:select.option value="">--Selecciona una opción---</flux:select.option>
                ...
                <flux:select  badge="Requerido" :label="__('Modalidad')" wire:model="modalidad_id" id="modalidad_id" class="w-full">
                    <flux:select.option value="">--Selecciona una opción---</flux:select.option>
