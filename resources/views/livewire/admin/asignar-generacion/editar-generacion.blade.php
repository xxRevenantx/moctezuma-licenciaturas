                    ...
                    <div class="w-120 border-2 border-gray-50  dark:bg-neutral-800 shadow-md rounded-3xl p-7 space-y-5">
                        ...
                        <div class="mb-4">
                            ...
                            <flux:field>
                                ...
                                <flux:select wire:model.live="licenciatura_id" id="licenciatura_id" class="w-full">
                            ...
                            <flux:field>
                                <flux:label>Generaciones</flux:label>
                                <flux:select wire:model.live="generacion_id" id="generacion_id" class="w-full">
