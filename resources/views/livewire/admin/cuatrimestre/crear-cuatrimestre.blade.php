<div>
    <div class="flex flex-col gap-4">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Crear Cuatrimestre</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">Formulario para crear un nuevo cuatrimestre.</p>
    </div>
    ...
    <div
        ...
        <form wire:submit.prevent="crearCuatrimestre" class="space-y-4 mt-4  p-2">
